# Plugin_repository_QGIS3
* QGIS3에 Plug-In하여 실행되는 프로그램과 모듈들을 모아 놓은 저장소입니다.  
    ([**K-FRM**](https://github.com/floodmodel/K-FRM), [**GPM**](https://github.com/floodmodel/GPM) 등은 각각의 repository 에서) <br/>      
* 프로그램에 대한 QGIS3에서의 plug-in install 방법 및 매뉴얼 등에 대한 정보는 위 [**Wiki 메뉴**](https://github.com/floodmodel/Plugin_repository_QGIS3/wiki) 에 설명되어 있습니다.<br/>
